...
namespace LeanCloud {
  ...
  public partial class AVPush {
    ...
    private static IAVPushController PushController {
      get {
        return AVPushPlugins.Instance.PushController;
      }
    }

    private static IAVPushChannelsController PushChannelsController {
      get {
        return AVPushPlugins.Instance.PushChannelsController;
      }
    }
    ...
    /// </summary>
    public static event EventHandler<AVPushNotificationEventArgs> ParsePushNotificationReceived {
      add {
