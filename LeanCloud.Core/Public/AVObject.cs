...
namespace LeanCloud
{
    ...
    /// </para>
    /// </remarks>
    public class AVObject : IEnumerable<KeyValuePair<string, object>>, INotifyPropertyChanged, IAVObject
    {
    ...
    private static readonly bool isCompiledByIL2CPP = AppDomain.CurrentDomain.FriendlyName.Equals("IL2CPP Root Domain");
        ...
        /// for <see cref="ParseUser"/>), then the appropriate type of AVObject is returned.
        /// </summary>
