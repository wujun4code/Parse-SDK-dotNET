    ...
    public class AVPlugins : IAVCorePlugins
    {
        ...
        public IAVFileController FileController
        {
            get
            {
                lock (mutex)
                {
                    if (AVClient.CurrentConfiguration.Region == AVClient.Configuration.AVRegion.Public_CN)
                        fileController = fileController ?? new QiniuFileController(CommandRunner);
                    else if (AVClient.CurrentConfiguration.Region == AVClient.Configuration.AVRegion.Vendor_Tencent)
