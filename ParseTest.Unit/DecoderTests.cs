...
namespace LeanCloudTest {
  ...
  public class DecoderTests {
    ...
    public void TestAVDate() {
      DateTime dateTime = (DateTime)AVDecoder.Instance.Decode(AVDecoder.AVDate("1990-08-30T12:03:59.000Z"));
    ...
    public void TestDecodeFieldOperation() {
      ...
      // Decoding AVFieldOperation is not supported on .NET now. We only need this for LDS.
