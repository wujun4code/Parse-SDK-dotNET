  ...
  public static class AVCloud {
    ...
    public static Task<T> CallFunctionAsync<T>(
      String name, IDictionary<string, object> parameters, CancellationToken cancellationToken) {
		...
		{
			return AVClient.RequestAsync("POST", new Uri(string.Format("/1.1/functions/{0}", Uri.EscapeUriString(name)), UriKind.Relative), AVUser.CurrentSessionToken, (IDictionary<string, object>)AVClient.BuildQueryString(parameters, false), cancellationToken).OnSuccess<Tuple<HttpStatusCode, IDictionary<string, object>>, string>((Task<Tuple<HttpStatusCode, IDictionary<string, object>>> t) =>
			                                                                                                                                                                                                                                                                                                                                 {
		...
		public static Task<bool> RequestSMSCode(string mobilePhoneNumber, string name, string op, int ttl, CancellationToken cancellationToken)
		{
			...
			return AVClient.RequestAsync("POST", "/1.1/requestSmsCode", null, strs, cancellationToken).OnSuccess<Tuple<HttpStatusCode, IDictionary<string, object>>, bool>((Task<Tuple<HttpStatusCode, IDictionary<string, object>>> t) =>
			                                                                                                                                                           {
